...
!(function (t, e) {
  ...
  function f(t, e, n) {
    var r,
      o = (s((r = {}), t, e), s(r, "path", "/"), s(r, "expires", void 0), r);
    if (n) {
      var i = new Date();
  ...
  function v(t, e) {
    e
      ? f(t._options.dontShowAgainCookie, m, t._options.dontShowAgainCookieDays)
      : f(t._options.dontShowAgainCookie, "", -1);
  }
  var b,
    y =
      ((b = {}),
          ...
          },
          {
            ...
            value: function (t, e, n, r, o) {
              ...
              "addEventListener" in t
                ...
                : "attachEvent" in t && t.attachEvent("on".concat(e), a),
            ...
            value: function (t, e, n, r, o) {
              ...
              a &&
                ("removeEventListener" in t
                  ...
                  : "detachEvent" in t && t.detachEvent("on".concat(e), a),
  ...
  function j(t, e, n, r, o) {
    ...
    if (
      ...
      var a = S().height;
      i.bottom - (i.bottom - i.top) < 0 || r.clientHeight > a
        ? window.scrollBy(0, i.top - (a / 2 - i.height / 2) - n)
        : window.scrollBy(0, i.top - (a / 2 - i.height / 2) + n);
    }
  }
  function A(t) {
  ...
  function E(t) {
    ...
    return (
      !(!e || "HTML" === e.nodeName) && ("fixed" === k(t, "position") || E(e))
    );
  }
  function N(t, e) {
    var n = document.body,
    ...
    return ("body" !== e.tagName.toLowerCase() && "relative" === l) ||
      ...
      : Object.assign(c, { top: a.top + o, left: a.left + i });
  }
  function L(t, e) {
    if (t instanceof SVGElement) {
      var n = t.getAttribute("class") || "";
  ...
  function I(t, e, n) {
    if (n && e) {
      ...
      e.element instanceof Element && E(e.element)
        ? _(n, "introjs-fixedTooltip")
        : L(n, "introjs-fixedTooltip"),
  ...
  function B(t, e, n, r) {
    var o = t.slice(),
      ...
      c = "floating";
    if (
      (l.bottom + a > i.height && q(o, "bottom"),
      l.top - a < 0 && q(o, "top"),
      l.right + s > i.width && q(o, "right"),
      l.left - s < 0 && q(o, "left"),
      r && (r = r.split("-")[0]),
      o.length && ((c = o[0]), o.includes(r) && (c = r)),
      "top" === c || "bottom" === c)
    ) {
      var u,
        p = [];
      "top" === c
        ...
        (c =
          (function (t, e, n, r) {
            ...
            return (
              i - t < e &&
                (q(r, "top-left-aligned"), q(r, "bottom-left-aligned")),
              (t < o || i - t < o) &&
                (q(r, "top-middle-aligned"), q(r, "bottom-middle-aligned")),
              t < e &&
                (q(r, "top-right-aligned"), q(r, "bottom-right-aligned")),
              r.length ? r[0] : null
            );
    ...
    if (e) {
      ...
      (n.style.top = ""),
        ...
        "floating" !== (l = e.position) &&
          ...
          (l = B(t._options.positionPrecedence, e.element, n, l)),
        (a = N(e.element)),
        (i = N(n)),
        (s = S()),
      ...
      switch (l) {
        ...
        case "top-middle-aligned":
          (r.className = "introjs-arrow bottom-middle"),
            o && (u += 5),
            O(a, u, i, n) && ((n.style.right = ""), P(a, u, i, s, n)),
          ...
          (n.style.left = "".concat(a.width + 20, "px")),
            a.top + i.height > s.height
              ? ((r.className = "introjs-arrow left-bottom"),
                (n.style.top = "-".concat(i.height - a.height - 20, "px")))
  ...
  function M(t, e) {
    ...
    for (var o in e) {
      var i = e[o];
      "style" === o && "function" != typeof i
        ? T(n, i)
        : "string" == typeof i && o.match(r)
        ? n.setAttribute(o, i)
        : (n[o] = i);
    }
    return n;
  ...
  function G(t, e) {
    ...
    null === n &&
      ((n = M("div", { className: "introjs-disableInteraction" })),
      t._targetElement.appendChild(n)),
      I(t, e, n);
  }
  function V(t, e) {
    var n = M("div", { className: "introjs-bullets" });
  ...
  function z(t, e, n) {
    if (t) {
      var r = e.querySelector(".introjs-bullets li > a.active"),
        o = e.querySelector(
          '.introjs-bullets li > a[data-step-number="'.concat(n.step, '"]')
        );
  ...
  function W(t) {
    ...
    t._options.progressBarAdditionalClass &&
      (n.className += " " + t._options.progressBarAdditionalClass);
            ...
            switch ((e.prev = e.next)) {
              ...
              case 3:
                if (
                  ...
                  "string" == typeof n._options.highlightClass &&
                    (s += " ".concat(n._options.highlightClass)),
                  null !== i && null !== a
                    ? ((p = a.querySelector(".introjs-helperNumberLayer")),
                      ...
                      I(n, o, a),
                      R(),
                      n._lastShowElementTimer &&
                        window.clearTimeout(n._lastShowElementTimer),
                      (n._lastShowElementTimer = window.setTimeout(function () {
                        null !== p &&
                          ...
                          ((null != l &&
                            ...
                            l.focus(),
                          j(
                            n._options.scrollToElement,
                            o.scrollTo,
                            n._options.scrollPadding,
                            o.element,
                            h
                          );
                      }, 350)))
                    : ((v = M("div", { className: s })),
                      ...
                      (y = M("div", { className: "introjs-arrow" })),
                      (g = M("div", { className: "introjs-tooltip" })),
                      (k = M("div", { className: "introjs-tooltiptext" })),
                      (S = M("div", { className: "introjs-tooltip-header" })),
                      (E = M("h1", { className: "introjs-tooltip-title" })),
                      (N = M("div")),
                      T(v, {
                        "box-shadow":
                      ...
                      !1 === n._options.showButtons &&
                        (N.style.display = "none"),
                      S.appendChild(E),
                      g.appendChild(S),
                      g.appendChild(k),
                      n._options.dontShowAgain &&
                        ((L = M("div", { className: "introjs-dontShowAgain" })),
                        ((P = M("input", {
                          type: "checkbox",
                      ...
                      A((u = M("a", { className: "introjs-skipbutton" }))),
                  ...
                  (B = n._targetElement.querySelector(
                    ".introjs-disableInteraction"
                  )) &&
                    B.parentNode &&
                    B.parentNode.removeChild(B),
                  o.disableInteraction && G(n, o),
                  0 === n._currentStep && n._introItems.length > 1
                    ? (null != l &&
                        ((l.className = "".concat(
                          n._options.buttonClass,
                          " introjs-nextbutton"
                        )),
                        (l.innerHTML = n._options.nextLabel)),
                      !0 === n._options.hidePrev
                        ? (null != c &&
                            (c.className = "".concat(
                              n._options.buttonClass,
                              " introjs-prevbutton introjs-hidden"
                            )),
                          null != l && _(l, "introjs-fullbutton"))
                        : null != c &&
                          (c.className = "".concat(
                            n._options.buttonClass,
                    ...
                    : n._introItems.length - 1 === n._currentStep ||
                      1 === n._introItems.length
                    ? (null != c &&
                        (c.className = "".concat(
                          n._options.buttonClass,
                          " introjs-prevbutton"
                        )),
                      !0 === n._options.hideNext
                        ? (null != l &&
                            (l.className = "".concat(
                              n._options.buttonClass,
                              " introjs-nextbutton introjs-hidden"
                            )),
                          null != c && _(c, "introjs-fullbutton"))
                        : null != l &&
                          (!0 === n._options.nextToDone
                            ? ((l.innerHTML = n._options.doneLabel),
                              _(
                                l,
                                "".concat(
                                  n._options.buttonClass,
                ...
                return (
                  (e.next = 21), n._introAfterChangeCallback.call(n, o.element)
                );
              case 21:
              case "end":
                return e.stop();
          ...
          return t().wrap(function (t) {
            for (;;)
              switch ((t.prev = t.next)) {
                case 0:
                  if (
                    ((n._direction = "forward"),
                    void 0 !== n._currentStepNumber)
                  )
                    for (r = 0; r < n._introItems.length; r++)
                      n._introItems[r].step === n._currentStepNumber &&
                        ((n._currentStep = r - 1),
                  ...
                  return (
                    (t.next = 8),
                    n._introBeforeChangeCallback.call(
                      n,
                      o && o.element,
                      n._currentStep,
                      n._direction
        ...
        return t().wrap(function (t) {
          for (;;)
            switch ((t.prev = t.next)) {
              case 0:
                if (
                  (null === (o = void 0 === r.code ? r.which : r.code) &&
                    (o = null === r.charCode ? r.keyCode : r.charCode),
        ...
        return t().wrap(function (t) {
          for (;;)
            switch ((t.prev = t.next)) {
              case 0:
                if (
                  ((o = st('.introjs-hint[data-step="'.concat(r, '"]'))[0]),
                  _t(),
            ...
            switch ((t.prev = t.next)) {
              case 0:
                null === (r = document.querySelector(".introjs-hints")) &&
                  (r = M("div", { className: "introjs-hints" })),
                  (o = function (t) {
                    return function (e) {
              ...
              case 8:
                A((s = M("a", { className: "introjs-hint" }))),
                  (s.onclick = o(i)),
                  a.hintAnimation || _(s, "introjs-hint-no-anim"),
                  E(a.element) && _(s, "introjs-fixedhint"),
                  (l = M("div", { className: "introjs-hint-dot" })),
                  (c = M("div", { className: "introjs-hint-pulse" })),
                  s.appendChild(l),
                  s.appendChild(c),
              ...
              case 29:
                n._options.hintAutoRefreshInterval >= 0 &&
                  ((n._hintsAutoRefreshFunction = at(function () {
                    return Ct(n);
          ...
          for (;;)
            switch ((t.prev = t.next)) {
              case 0:
                if (
                  ((o = document.querySelector(
                    '.introjs-hint[data-step="'.concat(r, '"]')
                  )),
                  (i = n._hintItems[r]),
              ...
              case 5:
                ...
                return t.abrupt("return");
              case 8:
                (s = M("div", { className: "introjs-tooltip" })),
                  (l = M("div")),
                  (c = M("div")),
                  (u = M("div")),
                  ...
                  l.appendChild(p),
                  n._options.hintShowButton &&
                    (((h = M("a")).className = n._options.buttonClass),
            ...
            switch ((t.prev = t.next)) {
              case 0:
                ...
                try {
                  for (o.s(); !(i = o.n()).done; )
                    (a = i.value),
                      "string" == typeof (s = it(a)).element &&
                        (s.element = document.querySelector(s.element)),
                      (s.hintPosition =
                        s.hintPosition || n._options.hintPosition),
                      (s.hintAnimation =
                        s.hintAnimation || n._options.hintAnimation),
              ...
              case 6:
                if (
                  (l = Array.from(r.querySelectorAll("*[data-hint]"))) &&
                  l.length
                ) {
                  t.next = 9;
                  break;
                ...
                for (c = 0, u = l; c < u.length; c++)
                  (h = u[c]),
                    ...
                    n._hintItems.push({
                      ...
                      hintPosition:
                        h.getAttribute("data-hint-position") ||
                        n._options.hintPosition,
                      hintAnimation: d,
                      tooltipClass:
                        h.getAttribute("data-tooltip-class") || void 0,
                      position:
                        h.getAttribute("data-position") ||
                        n._options.tooltipPosition,
                    });
              case 10:
                return (t.next = 12), vt(n);
              case 12:
                return (
                  g.on(document, "click", _t, n, !1),
    ...
    if (t._options.steps && t._options.steps.length) {
        ...
        for (i.s(); !(o = i.n()).done; ) {
          ...
          if (
            ...
            "string" == typeof a.element &&
              (a.element = document.querySelector(a.element) || void 0),
            void 0 === a.element || null === a.element)
          ) {
            var s = document.querySelector(".introjsFloatingElement");
            null === s &&
              ((s = M("div", { className: "introjsFloatingElement" })),
          ...
          (a.position = a.position || t._options.tooltipPosition),
            ...
            void 0 === a.disableInteraction &&
              (a.disableInteraction = t._options.disableInteraction),
      ...
      try {
        for (u.s(); !(c = u.n()).done; ) {
          ...
          if (
            (!t._options.group ||
              h.getAttribute("data-intro-group") === t._options.group) &&
            "none" !== h.style.display
          ) {
            var f = parseInt(h.getAttribute("data-step") || "", 10);
            (l = t._options.disableInteraction),
              h.hasAttribute("data-disable-interaction") &&
                (l = !!h.getAttribute("data-disable-interaction")),
              f > 0 &&
                (r[f - 1] = {
                  step: f,
                  element: h,
                  ...
                  highlightClass:
                    h.getAttribute("data-highlight-class") || void 0,
                  position:
                    h.getAttribute("data-position") ||
                    t._options.tooltipPosition,
                  scrollTo:
                    h.getAttribute("data-scroll-to") || t._options.scrollTo,
      ...
      try {
        for (v.s(); !(d = v.n()).done; ) {
          ...
          if (
            (!t._options.group ||
              b.getAttribute("data-intro-group") === t._options.group) &&
            null === b.getAttribute("data-step")
          ) {
            for (; void 0 !== r[m]; ) m++;
            (l = b.hasAttribute("data-disable-interaction")
              ? !!b.getAttribute("data-disable-interaction")
              ...
              (r[m] = {
                ...
                highlightClass:
                  b.getAttribute("data-highlight-class") || void 0,
                position:
                  b.getAttribute("data-position") || t._options.tooltipPosition,
                scrollTo:
                  b.getAttribute("data-scroll-to") || t._options.scrollTo,
                disableInteraction: l,
              });
          }
        }
  ...
  function jt(t, e) {
    ...
    if (null != n && -1 != n) {
      ...
      I(t, r, i),
        ...
        I(t, r, a),
        e &&
          ((t._introItems = St(t, t._targetElement)),
          (function (t, e) {
          ...
          return t().wrap(function (t) {
            for (;;)
              switch ((t.prev = t.next)) {
                ...
                case 8:
                  if (
                    (a = Array.from(r.querySelectorAll(".introjs-overlay"))) &&
                    a.length
                  ) {
                    s = p(a);
                    try {
                  ...
                  if (
                    (Et(r.querySelector(".introjs-helperLayer"), !0),
  ...
  function Tt(e, n) {
    var o = M("div", { className: "introjs-overlay" });
    return (
      T(o, { top: 0, bottom: 0, left: 0, right: 0, position: "fixed" }),
      n.appendChild(o),
      !0 === e._options.exitOnOverlayClick &&
        (T(o, { cursor: "pointer" }),
        (o.onclick = r(
          t().mark(function r() {
            return t().wrap(function (t) {
        ...
        return t().wrap(function (t) {
          for (;;)
            switch ((t.prev = t.next)) {
              ...
              case 12:
                r.addEventListener,
                  n._options.keyboardNavigation &&
                    g.on(window, "keydown", rt, n, !0),
      ...
      function e(t) {
        o(this, e),
          ...
          (this._options = {
            ...
            dontShowAgain: !1,
            dontShowAgainLabel: "Não mostrar isso novamente!",
            ...
            value: function () {
              return (
                (!this._options.dontShowAgain ||
                  "" === (t = d(this._options.dontShowAgainCookie)) ||
                  t !== m) &&
                    ...
                    function (t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (
                              (t.next = 2), Nt(this, this._targetElement, n)
                            );
                          case 2:
                            return t.abrupt("return", this);
                          case 3:
